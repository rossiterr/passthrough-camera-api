...
namespace PassthroughCameraSamples.MultiObjectDetection
{
    ...
    public class SentisInferenceUiManager : MonoBehaviour
    {
        ...
        {
            bool isDangerousObject = box.ClassName.ToLower().Contains("scissors") ||
                                     box.ClassName.ToLower().Contains("knife") ||
                                     box.ClassName.ToLower().Contains("handgun") ||
                                     box.ClassName.ToLower().Contains("rifle") ||
                                     box.ClassName.ToLower().Contains("bottle");
